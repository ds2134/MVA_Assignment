...
Q:How does the mean of Total Air Quality Index readings gives information about Air Quality?
...
Q: Considering the variance of Total Air Quality Index readings, how does the magnitude of variance indicate the spread or variability in air quality across different locations?
...
plot_f_test_result <- function(data) {
  ...
  # Create plot
  plot(density(var1), col = "blue", main = "F-Test Result: Air Quality Index vs. Healthcare Index", 
